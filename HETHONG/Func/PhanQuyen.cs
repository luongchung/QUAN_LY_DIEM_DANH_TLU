...
namespace HeThong.Func
{
    ...
    {
        public static void phanQuyenNavBar(System.Windows.Forms.Form frm, NhanVien objnhanvien, DevExpress.XtraBars.Ribbon.RibbonControl ribbon, DevExpress.XtraNavBar.NavBarControl control)
        {
